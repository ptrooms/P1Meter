...
## [v21.78c] - Base version working new RXREAD59  
    ...
    - texutual update changed.ms to comply via markUp language
    - updated code
        - softserial, disabled (de)activation of BlueLed2/D4 on short-bit faults when running standard (OK) bitwait.
            - this to allow normal use for BlueLed signalling in main program.
        - renamed sensor WATERSENSOR_READ to just WATERSENSOR (a sensor is already input/read)
        - Improved CycleRecoverwaterErrorSwitch() called when CRC=Ok on Telegram and tapping hotwater processHotLedRead().
        - waterTriggerCnt tested against LIMIT_WATERTRIGGERCNT=15 (to minimize overruns)
        - version constant from v78 to v78c
        - multi-lined some long-line sample constants.         
    - skipped version 78a & 78b as these lack stability in processing telegrams. Not sure what caused this. 
